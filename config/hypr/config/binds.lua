...
hl.bind(mainMod .. " + CONTROL + Print", hl.dsp.exec_cmd("~/.local/bin/ocr-screenshot"))
hl.bind(mainMod .. " + SHIFT + P",       hl.dsp.exec_cmd("~/.local/bin/mirror-projector"))
...
-- Focus on workspace number (like Omarchy)
for i = 1, NUM_WPM do
    local key = i % 10
